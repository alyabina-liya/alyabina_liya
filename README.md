...
Я начинающий QA Engineer. Прошла обучение по тестированию веб и мобильных приложений. Умею писать тестовую документацию, работать с API и базами данных. Ищу первую работу в QA.
...
* **[🔗 Открыть примеры запросов](https://github.com/alyabina-liya/sql)**
