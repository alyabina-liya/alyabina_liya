...
Начинающий QA Engineer с хорошей теоретической базой ручного тестирования веб приложений. Постоянно развиваюсь: активно углубляюсь в Java и автоматизацию тестирования (UI / API).
